...
<title>강의평가 웹 사이트</title>
	...
	<link type="text/css" rel="stylesheet" href="<c:url value='/css/custom.css?ver=5' />" >
</head>
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="/DCULE/user/main">강의평가 웹 사이트</a>
	...
	<div class="container">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						성적 <span style="color: red;">A</span> 널널 <span style="color: red;">C</span>
						강의 <span style="color: red;">A</span> <span style="color: green;">(추천:
							0)</span>
					</div>
					<div class="col-3 text-right">
						<a onclick="return confirm('추천하시겠습니까?')"
